...
#define READ_TIMER 150				// set up (in ms) how often read the CHINT Power Meter
#define MQTT_TIMER 5000 			// set up (in ms) how often CHINT send data to MQTT Broker
...
void loop() {
  ...
  uint32_t start_loop = next_request;
